...
#define WR_REG0        0x01   // bit 0 enables qpi, default is 0
#define WR_MEM         0x02   //
#define RD_REG0        0x05   //
#define RD_REG1        0x07   // number of dummy cycles, default is 32
#define RD_MEM         0x0B   //
#define WR_REG1        0x11   //
#define WR_REG2        0x20   // wrap length, low 
#define RD_REG2        0x21   //
#define WR_REG3        0x30   // wrap length, high
#define RD_REG3        0x31   // 
